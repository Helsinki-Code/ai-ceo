...
- Fire externally: `POST /api/routine-triggers/public/{publicId}/fire`
  ...
  - HMAC: `X-AI CEO-Signature` + `X-AI CEO-Timestamp` headers
...
Use the generic API endpoint tables in `skills/ai-ceo/references/api-reference.md` when you need a full cross-domain reference. Use this file when you need routine-specific behaviour, payload shape, or policy details.
