# AI CEO API Reference

Detailed reference for the AI CEO control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "AI CEO Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "ai-ceo-mobile",
    "cwd": "/Users/me/ai-ceo-mobile",
    "repoUrl": "https://github.com/acme/ai-ceo-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `ai-ceo-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
