...
Eval framework for testing AI CEO agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the AI CEO heartbeat skill:
