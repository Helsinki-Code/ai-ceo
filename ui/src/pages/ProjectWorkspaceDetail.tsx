...
import { isUuidLike, type ProjectWorkspace } from "@ai-ceo/shared";
...
const SOURCE_TYPE_OPTIONS: Array<{ value: ProjectWorkspaceSourceType; label: string; description: string }> = [
  { value: "local_path", label: "Local git checkout", description: "A local path AI CEO can use directly." },
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-start sm:justify-between">
              <div className="space-y-2">
                ...
                <p className="max-w-2xl text-sm text-muted-foreground">
                  Configure the concrete workspace AI CEO attaches to this project. These values drive per-workspace
