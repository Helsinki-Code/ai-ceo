...
import { AGENT_ADAPTER_TYPES } from "@ai-ceo/shared";
import type {
  Agent,
...
// Canonical type lives in @ai-ceo/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@ai-ceo/adapter-utils";
import type { CreateConfigValues } from "@ai-ceo/adapter-utils";
  ...
  return (
    <div className="space-y-1.5">
      ...
      <p className="text-[11px] text-muted-foreground/60">
        AI_CEO_* variables are injected automatically at runtime.
      </p>
    </div>
  );
}
