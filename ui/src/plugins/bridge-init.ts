 ...
 *
 * This is placed on `globalThis.__aiCEOPluginBridge__` and consumed by
...
declare global {
  ...
  var __aiCEOPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__aiCEOPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__aiCEOPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
