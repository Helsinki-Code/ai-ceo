...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@ai-ceo/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@ai-ceo/adapter-utils").TranscriptEntry[];
