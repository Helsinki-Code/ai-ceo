...
export function pluginRegistryService(db: Db) {
  ...
  return {
     ...
     */
    install: async (input: InstallPlugin, manifest: AICEOPluginManifestV1) => {
    ...
    /**
     * Create or update a persistent mapping between a AI CEO object and an
     * external entity.
     *
     * @param pluginId - The UUID of the plugin.
