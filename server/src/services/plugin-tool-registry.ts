...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@ai-ceo/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: AICEOPluginManifestV1, pluginDbId?: string): void;
