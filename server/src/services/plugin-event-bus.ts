/**
 * PluginEventBus — typed in-process event bus for the AI CEO plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@ai-ceo/shared";
import type { PluginEvent, EventFilter } from "@ai-ceo/plugin-sdk";
