 ...
 */
import type { CompanyPortabilityManifest } from "@ai-ceo/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [AI CEO](https://ai-ceo.ing)");
  lines.push("");
