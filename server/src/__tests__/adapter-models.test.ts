...
import { models as codexFallbackModels } from "@ai-ceo/adapter-codex-local";
import { models as cursorFallbackModels } from "@ai-ceo/adapter-cursor-local";
import { models as opencodeFallbackModels } from "@ai-ceo/adapter-opencode-local";
import { resetOpenCodeModelsCacheForTests } from "@ai-ceo/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.AI_CEO_OPENCODE_COMMAND;
  ...
  it("returns opencode fallback models including gpt-5.4", async () => {
    process.env.AI_CEO_OPENCODE_COMMAND = "__ai_ceo_missing_opencode_command__";
