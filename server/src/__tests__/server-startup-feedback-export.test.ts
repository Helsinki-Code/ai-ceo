...
vi.mock("../config.js", () => ({
  loadConfig: vi.fn(() => ({
    ...
    databaseUrl: "postgres://ai-ceo:ai-ceo@127.0.0.1:5432/ai-ceo",
    embeddedPostgresDataDir: "/tmp/ai-ceo-test-db",
    embeddedPostgresPort: 54329,
    databaseBackupEnabled: false,
    databaseBackupIntervalMinutes: 60,
    databaseBackupRetentionDays: 30,
    databaseBackupDir: "/tmp/ai-ceo-test-backups",
    serveUi: false,
    uiDevMiddleware: false,
    secretsProvider: "local_encrypted",
    secretsStrictMode: false,
    secretsMasterKeyFilePath: "/tmp/ai-ceo-master.key",
    storageProvider: "local_disk",
    storageLocalDiskBaseDir: "/tmp/ai-ceo-storage",
    storageS3Bucket: "ai-ceo-test",
