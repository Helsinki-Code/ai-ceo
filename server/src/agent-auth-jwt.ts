...
function jwtConfig() {
  ...
  return {
    secret,
    ttlSeconds: parseNumber(process.env.AI_CEO_AGENT_JWT_TTL_SECONDS, 60 * 60 * 48),
    issuer: process.env.AI_CEO_AGENT_JWT_ISSUER ?? "ai-ceo",
    audience: process.env.AI_CEO_AGENT_JWT_AUDIENCE ?? "ai-ceo-api",
  };
}
