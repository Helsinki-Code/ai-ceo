...
This document defines the rollout plan for adapter-wide skill support in AI CEO.
...
- AI CEO stores desired skill state consistently even when the adapter cannot fully reconcile it
- unsupported adapters degrade clearly and safely

## 2. Current Adapter Matrix

AI CEO currently has these adapters:
...
1. Desired skills live in AI CEO for every adapter.
...
These adapters have a stable local skills directory that AI CEO can read and manage.
...
These adapters do not have a meaningful AI CEO-owned persistent install state.
...
- desired skills stored in AI CEO
...
- runtime already injects AI CEO skills into `~/.cursor/skills`
...
- runtime already injects AI CEO skills into `~/.gemini/skills`
...
- runtime already injects AI CEO skills into `~/.pi/agent/skills`
...
- AI CEO can sync desired skills into Pi’s persistent home
...
- OpenCode currently injects AI CEO skills into `~/.claude/skills`

This is product-risky because:

- it shares state with Claude
- AI CEO may accidentally imply the skills belong only to OpenCode when the home is shared
...
- only remove stale managed AI CEO skills that are clearly marked as AI CEO-managed
...
- AI CEO stores desired skills only
...
- avoid destructive wording unless AI CEO can prove a skill is AI CEO-managed
...
That gets AI CEO from “skills work for Codex and Claude” to “skills work for the whole local-adapter family,” which is the meaningful V1 milestone.
