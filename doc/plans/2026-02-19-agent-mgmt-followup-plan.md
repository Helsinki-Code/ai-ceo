...
- `skills/ai-ceo/SKILL.md` and `skills/ai-ceo/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.2 `skills/ai-ceo-create-agent/SKILL.md`
