...
AI CEO already treats budgets as a core control-plane responsibility:
...
This plan defines the concrete budgeting model AI CEO should implement next.

## Product Goals

AI CEO should let operators:
...
For the next implementation pass, AI CEO should enforce these defaults:
...
AI CEO should separate subscription-included usage from billed spend:
...
AI CEO should have two threshold classes:
...
AI CEO must know that a project is budget-paused and enforce it.
...
AI CEO must also block execution before new work starts.
