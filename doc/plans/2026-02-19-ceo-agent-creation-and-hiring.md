...
- installed adapter list for this AI CEO instance
...
## 8. New Skill: `ai-ceo-create-agent`

Create new skill directory:

- `skills/ai-ceo-create-agent/SKILL.md`
...
Also update `skills/ai-ceo/SKILL.md` to reference this skill for hiring workflows.
...
- `ai-ceo-create-agent` skill + docs updates
