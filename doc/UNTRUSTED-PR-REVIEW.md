...
This is intentionally separate from the normal AI CEO dev image.
...
```sh
review-checkout-pr ai-ceo/ai-ceo 432
cd /work/checkouts/ai-ceo-ai-ceo/pr-432
```
...
## Preview the AI CEO app from the PR
...
- AI CEO's embedded PostgreSQL and local storage stay inside the container home volume via `AI_CEO_HOME=/home/reviewer/.ai-ceo-review`.
