...
This document covers the GitHub and npm setup required for the current AI CEO release model:
...
Do this for every public package that AI CEO publishes.
...
3. add a trusted publisher for the GitHub repository `ai-ceo/ai-ceo`
...
2. revoke any personal automation token that used to publish AI CEO
