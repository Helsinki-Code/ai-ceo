...
Manage companies within your AI CEO instance.
...
Company logo uploads use the normal AI CEO attachment size limit.
...
| `logoUrl` | string | Optional AI CEO asset content path for the stored logo image |
