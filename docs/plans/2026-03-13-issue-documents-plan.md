...
Add first-class **documents** to AI CEO as editable, revisioned, company-scoped text artifacts that can be linked to issues.
...
The `plan` key is conventional and reserved by AI CEO workflow/docs.
...
Update the AI CEO agent workflow so planning no longer edits the issue description.

Required changes:

- update `skills/ai-ceo/SKILL.md`
