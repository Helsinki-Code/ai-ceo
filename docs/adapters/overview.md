...
summary: What adapters are and how they connect agents to AI CEO
---

Adapters are the bridge between AI CEO's orchestration layer and agent runtimes. Each adapter knows how to invoke a specific type of AI agent and capture its results.

## How Adapters Work

When a heartbeat fires, AI CEO:
...
packages/adapters/<name>/
  src/
    ...
    cli/
      format-event.ts   # Terminal output for `ai-ceo run --watch`
```
