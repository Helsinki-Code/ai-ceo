...
- Running a Python script that calls the AI CEO API
...
1. AI CEO spawns the configured command as a child process
2. Standard AI CEO environment variables are injected (`AI_CEO_AGENT_ID`, `AI_CEO_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the AI CEO API and perform work.
