...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within AICEOPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the AI CEO host.
 *
 ...
 */
export interface AICEOPluginManifestV1 {
   ...
   */
  minimumAICEOVersion?: PluginMinimumHostVersion;
