import type { PluginLauncherRegistration } from "@ai-ceo/plugin-sdk";

export const PLUGIN_ID = "ai-ceo-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".ai-ceo-kitchen-sink-demo.txt",
} as const;
