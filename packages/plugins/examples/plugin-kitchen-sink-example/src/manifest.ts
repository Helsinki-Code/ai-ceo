...
const manifest: AICEOPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current AI CEO plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "AI CEO",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the AI CEO domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
