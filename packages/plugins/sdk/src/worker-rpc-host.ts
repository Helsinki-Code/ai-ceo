...
import type { AICEOPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@ai-ceo/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: AICEOPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@ai-ceo/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
