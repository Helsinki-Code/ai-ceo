 ...
 * channel.
 *
 * The AI CEO plugin runtime uses JSON-RPC 2.0 over stdio to communicate
...
export type { PluginLauncherRenderContextSnapshot } from "@ai-ceo/shared";
 ...
 * we use strings (UUIDs or monotonic counters) for all AI CEO messages.
 */
...
/**
 * AI CEO plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this AI CEO instance. */
    instanceId: string;
    /** Semver version of the running AI CEO host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
