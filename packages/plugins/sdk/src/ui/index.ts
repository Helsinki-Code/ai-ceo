/**
 * `@ai-ceo/plugin-sdk/ui` — AI CEO plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@ai-ceo/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@ai-ceo/plugin-sdk/ui";
 *
