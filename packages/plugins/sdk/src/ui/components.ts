 ...
 *
 * These components are exported from `@ai-ceo/plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@ai-ceo/plugin-sdk/ui`
 */
...
function createSdkUiComponent<TProps>(name: string): React.ComponentType<TProps> {
  return function AICEOSdkUiComponent(props: TProps) {
