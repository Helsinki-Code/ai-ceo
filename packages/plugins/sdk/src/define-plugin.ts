/**
 * `definePlugin` — the top-level helper for authoring a AI CEO plugin.
 *
...
// ---------------------------------------------------------------------------
// AICEOPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 * @returns A sealed `AICEOPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@ai-ceo/plugin-sdk";
 ...
 * @see PLUGIN_SPEC.md §14.1 — Example SDK Shape
 */
export function definePlugin(definition: PluginDefinition): AICEOPlugin {
