...
async function ensureEmbeddedPostgresConnection(
  ...
  const preferredAdminConnectionString = `postgres://ai-ceo:ai-ceo@127.0.0.1:${preferredPort}/postgres`;
  ...
  if (!runningPid && existsSync(pgVersionFile)) {
    try {
      ...
      await ensurePostgresDatabase(preferredAdminConnectionString, "ai-ceo");
      process.emitWarning(
      ...
      return {
        connectionString: `postgres://ai-ceo:ai-ceo@127.0.0.1:${preferredPort}/ai-ceo`,
  ...
  if (runningPid) {
    ...
    return {
      connectionString: `postgres://ai-ceo:ai-ceo@127.0.0.1:${port}/ai-ceo`,
  ...
  const adminConnectionString = `postgres://ai-ceo:ai-ceo@127.0.0.1:${selectedPort}/postgres`;
  await ensurePostgresDatabase(adminConnectionString, "ai-ceo");

  return {
    connectionString: `postgres://ai-ceo:ai-ceo@127.0.0.1:${selectedPort}/ai-ceo`,
