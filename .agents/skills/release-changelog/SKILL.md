...
description: >
  Generate the stable AI CEO release changelog at releases/vYYYY.MDD.P.md by
  reading commits, changesets, and merged PR context since the last stable tag.
---

# Release Changelog Skill

Generate the user-facing changelog for the **stable** AI CEO release.

## Versioning Model

AI CEO uses **calendar versioning (calver)**:
...
```
- **Feature name** — Description. ([#123](https://github.com/ai-ceo/ai-ceo/pull/123), @contributor1, @contributor2)
```
