...
name: release
description: >
  Coordinate a full AI CEO release across engineering verification, npm,
...
Run the full AI CEO maintainer release workflow, not just an npm publish.
...
7. If running through AI CEO, you have issue context for status updates and follow-up task creation.
...
AI CEO now uses a commit-driven release model:
...
npm view ai-ceo@canary version
```
...
- release summary in AI CEO issue context
